...
class TomlParser {
 ...
 public:
   ...
   */
  std::expected<bool, quick::error::TomlParserError> is_valid(
      std::ifstream& file) noexcept;

  std::expected<bool, quick::error::TomlParserError> extract_keys(
      std::ifstream& file) noexcept;
...
inline TomlParser::TomlParser(const std::filesystem::path& path) noexcept
    : m_filepath{path} {}

inline std::optional<std::string> TomlParser::get_value(
...
inline auto TomlParser::load() noexcept
    -> std::expected<bool, quick::error::TomlParserError> {
...
inline auto TomlParser::extract_keys(std::ifstream& file) noexcept
    -> std::expected<bool, quick::error::TomlParserError> {
  std::string line;
...
inline auto TomlParser::is_valid(std::ifstream& file) noexcept
    -> std::expected<bool, quick::error::TomlParserError> {
  return std::unexpected(quick::error::TomlParserError::INVALID_TOML);
}
